    ...
    _contextMenu(new QMenu(this))
{
    ...
    QAction* threeDOutLeft = new QAction(tr("Output 2D left"), this);
    ...
    QAction* threeDOutRight = new QAction(tr("Output 2D right"), this);
    ...
    QAction* threeDOutStereo = new QAction(tr("Output 3D OpenGL Stereo"), this);
    ...
    QAction* threeDOutAlternating = new QAction(tr("Output 3D alternating"), this);
