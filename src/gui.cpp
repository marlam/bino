    ...
    _contextMenu(new QMenu(this))
{
    ...
    QAction* threeDOutLR = new QAction(tr("Output left/right"), this);
    ...
    addBinoAction(threeDOutLR, threeDMenu);
    QAction* threeDOutLRH = new QAction(tr("Output left/right half width"), this);
    ...
    addBinoAction(threeDOutLRH, threeDMenu);
    QAction* threeDOutRL = new QAction(tr("Output right/left"), this);
    ...
    addBinoAction(threeDOutRL, threeDMenu);
    QAction* threeDOutRLH = new QAction(tr("Output right/left half width"), this);
    ...
    addBinoAction(threeDOutRLH, threeDMenu);
    QAction* threeDOutTB = new QAction(tr("Output top/bottom"), this);
    ...
    addBinoAction(threeDOutTB, threeDMenu);
    QAction* threeDOutTBH = new QAction(tr("Output top/bottom half height"), this);
    ...
    addBinoAction(threeDOutTBH, threeDMenu);
    QAction* threeDOutBT = new QAction(tr("Output bottom/top"), this);
    ...
    addBinoAction(threeDOutBT, threeDMenu);
    QAction* threeDOutBTH = new QAction(tr("Output bottom/top half height"), this);
    ...
    addBinoAction(threeDOutBTH, threeDMenu);
